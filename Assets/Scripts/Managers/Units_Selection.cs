...
public class Units_Selection : MonoBehaviour
{
    ...
    private CapsuleCollider capsulColl;

    private RectTransform rt;

    private bool isSelecting;

    public static Units_Selection selectionInstance;
    ...
    {
        List<Selectable> s = new List<Selectable>();
